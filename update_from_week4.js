/**
 * update_from_week4.js
 * Imports messages from json/03.09 - 03.15/ into both databases.
 * Uses last timestamps from json/02.03 - 08.03/ as thresholds to avoid duplicates.
 */
...
const jsonDirNew = path.join(__dirname, 'json', '03.09 - 03.15');
...
// Last timestamps from json/02.03 - 08.03/ — used as thresholds to skip already-imported messages
const lastTimestamps = {
    'art-memes.json':    '2026-03-08T20:54:06.622+03:00',
    'content.json':      '2026-03-01T23:56:45.462+03:00',
    'fluton-pets.json':  '2026-03-08T18:43:42.637+03:00',
    'general.json':      '2026-03-08T20:57:20.672+03:00',
    'gm.json':           '2026-03-08T21:17:20.906+03:00',
    'indian.json':       '2026-03-08T21:14:37.569+03:00',
    'indonesian.json':   '2026-03-08T21:29:24.726+03:00',
    'nigerian.json':     '2026-03-08T21:47:59.89+03:00',
    'russian.json':      '2026-03-08T21:54:41.176+03:00',
    'share-content.json':'2026-03-08T21:15:19.458+03:00',
    'vietnamese.json':   '2026-03-08T21:35:44.917+03:00',
    // New channels (Bangladeshi, Chinese, Pakistani, Portuguese, Turkey, ukraine) — no threshold
};

// Skip mascot-competition.json — handled separately by fetch_mascot.js
...
function start() {
    ...
    console.log(`Starting update from "03.09 - 03.15". Found ${files.length} files.`);
