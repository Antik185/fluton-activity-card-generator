/**
 * update_from_week3.js
 * Imports messages from json/02.03 - 08.03/ into both databases.
 * Uses last timestamps from json/2/ as thresholds to avoid duplicates.
 */
...
const jsonDirNew = path.join(__dirname, 'json', '02.03 - 08.03');
...
// Last timestamps from json/2/ — used as thresholds to skip already-imported messages
const lastTimestamps = {
    'art-memes.json':   '2026-03-01T23:53:54.848+03:00',
    'content.json':     '2026-03-01T23:56:45.462+03:00',
    'fluton-pets.json': '2026-03-01T22:40:28.746+03:00',
    'general.json':     '2026-03-01T23:52:54.484+03:00',
    'gm.json':          '2026-03-02T00:02:53.338+03:00',
    'indian.json':      '2026-03-02T00:10:14.927+03:00',
    'indonesian.json':  '2026-03-02T00:12:17.605+03:00',
    'nigerian.json':    '2026-03-01T22:25:41.815+03:00',
    'russian.json':     '2026-03-01T23:46:18.996+03:00',
    'vietnamese.json':  '2026-03-01T21:22:57.955+03:00',
    // share-content.json is a new channel — no threshold (import all)
};
...
function start() {
    ...
    console.log(`Starting update from "02.03 - 08.03". Found ${files.length} files.`);
