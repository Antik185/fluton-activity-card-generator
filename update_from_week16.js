/**
 * update_from_week16.js
 * Imports messages from json/08.06 - 14.06/ into both databases.
 * Automatically uses last timestamps from json/01.06 - 07.06/ to avoid duplicates.
...
const jsonDirNew = path.join(__dirname, 'json', '08.06 - 14.06');
const jsonDirOld = path.join(__dirname, 'json', '01.06 - 07.06');
...
const FILENAME_MAP = {
    'Pakistani.json':     'pakistani.json',
    'indian.json':        'indian-chat.json',
...
function start() {
    ...
    console.log(`Starting update from "08.06 - 14.06". Found ${files.length} files.`);
