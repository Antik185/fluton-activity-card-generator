/**
 * update_from_week12.js
 * Imports messages from json/11.05-17.05/ into both databases.
 * Automatically uses last timestamps from json/04.05-10.05/ to avoid duplicates.
 */
...
const jsonDirNew = path.join(__dirname, 'json', '11.05-17.05');
const jsonDirOld = path.join(__dirname, 'json', '04.05-10.05'); // Предыдущая папка для авто-фильтра
...
function start() {
    ...
    console.log(`Starting update from "11.05-17.05". Found ${files.length} files.`);
