/**
 * update_from_week13.js
 * Imports messages from json/18.05-24.05/ into both databases.
 * Automatically uses last timestamps from json/11.05-17.05/ to avoid duplicates.
 */
...
const jsonDirNew = path.join(__dirname, 'json', '18.05-24.05');
const jsonDirOld = path.join(__dirname, 'json', '11.05-17.05'); // Предыдущая папка для авто-фильтра
...
function start() {
    ...
    console.log(`Starting update from "18.05-24.05". Found ${files.length} files.`);
