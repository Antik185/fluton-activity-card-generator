/**
 * update_from_week10.js
 * Imports messages from json/19.04-03.05/ into both databases.
 * Automatically uses last timestamps from json/13.04-19.04/ to avoid duplicates.
 */
...
const jsonDirNew = path.join(__dirname, 'json', '19.04-03.05');
const jsonDirOld = path.join(__dirname, 'json', '13.04-19.04'); // Предыдущая папка для авто-фильтра
...
function start() {
    ...
    console.log(`Starting update from "19.04-03.05". Found ${files.length} files.`);
