/**
 * update_from_week17.js
 * Imports messages from json/15.06-21.06/ into both databases.
 * Automatically uses last timestamps from json/08.06 - 14.06/ to avoid duplicates.
...
const jsonDirNew = path.join(__dirname, 'json', '15.06-21.06');
const jsonDirOld = path.join(__dirname, 'json', '08.06 - 14.06');
...
const FILENAME_MAP = {
    ...
    'pakistani-chat.json':   'Pakistani.json',
    'turkce-chat.json':      'Turkey.json',
...
function start() {
    ...
    console.log(`Starting update from "15.06-21.06". Found ${files.length} files.`);
