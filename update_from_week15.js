/**
 * update_from_week15.js
 * Imports messages from json/01.06 - 07.06/ into both databases.
 * Automatically uses last timestamps from json/25.05-31.05/ to avoid duplicates.
...
const jsonDirNew = path.join(__dirname, 'json', '01.06 - 07.06');
const jsonDirOld = path.join(__dirname, 'json', '25.05-31.05');
...
const FILENAME_MAP = {
    ...
    'indonesian.json':  'indonesian-chat.json',
    'nigerian.json':    'nigerian-chat.json',
};
...
function start() {
    ...
    console.log(`Starting update from "01.06 - 07.06". Found ${files.length} files.`);
